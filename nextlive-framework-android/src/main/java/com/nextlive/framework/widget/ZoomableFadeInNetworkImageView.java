...
public class ZoomableFadeInNetworkImageView extends NetworkImageView {
    ...
    public ZoomableFadeInNetworkImageView(Context context) {
        super(context);
        init(context);
    }

    public ZoomableFadeInNetworkImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ZoomableFadeInNetworkImageView(Context context, AttributeSet attrs, int defStyle) {
